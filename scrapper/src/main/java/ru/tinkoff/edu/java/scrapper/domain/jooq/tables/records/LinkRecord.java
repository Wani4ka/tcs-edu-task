...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
     ...
     */
    public void setLastEvent(@NotNull OffsetDateTime value) {
        set(3, value);
    }
    ...
    public LinkRecord(@NotNull Long id, @NotNull String url, @NotNull OffsetDateTime lastCheck, @NotNull OffsetDateTime lastEvent) {
        super(Link.LINK);
    ...
    public LinkRecord(ru.tinkoff.edu.java.scrapper.domain.jooq.tables.pojos.Link value) {
        ...
        if (value != null) {
            ...
            setLastEvent(value.getLastEvent());
        }
    }
}
